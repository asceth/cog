defmodule Cog.Chat.Mattermost.Templates.Embedded.RelayGroupMemberRemoveTest do
  ...
  test "relay-group-member-remove template" do
    ...
    assert_rendered_template(:mattermost, :embedded, "relay-group-member-remove", data, expected)
  end
end

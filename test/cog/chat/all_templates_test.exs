defmodule Cog.Chat.AllTemplatesTest do
  ...
  test "all embedded templates have Mattermost tests" do
    {have_tests, no_tests} = tested_untested("mattermost")
    if no_tests == [] do
      :ok
    else
      flunk """
      The following embedded bundle templates do not have Mattermost
      rendering tests defined:

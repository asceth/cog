defmodule Cog.Chat.Mattermost.Templates.Embedded.GroupMemberRemoveTest do
  ...
  test "group-member-remove template" do
    ...
    assert_rendered_template(:mattermost, :embedded, "group-member-remove", data, expected)
  end
end

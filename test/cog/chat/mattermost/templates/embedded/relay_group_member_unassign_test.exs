defmodule Cog.Chat.Mattermost.Templates.Embedded.RelayGroupMemberUnassignTest do
  ...
  test "relay-group-member-unassign template" do
    ...
    assert_rendered_template(:mattermost, :embedded, "relay-group-member-unassign", data, expected)
  end
end
